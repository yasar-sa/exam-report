...
export default function CategoryPerformanceReport({
  ...
  const syncFromSavedReport = (savedReport) => {
    ...
    setSliderValues(
      savedReport.config?.sliderValues || {
        courseAtRisk: 70,
        studentAtRisk: 70,
      },
    );
    ...
    <div className="report-body-container pt-2">
      <div className="mb-4">
        ...
        <div style={{ fontSize: "11px", color: "#666", marginTop: "4px" }}>
          ...
          | At-Risk Course Threshold: {report?.thresholds?.courseAtRisk ?? 0}% | At-Risk Student
      ...
      >
        ...
        <div style={{ fontSize: "12px", color: "#666", marginBottom: "20px" }}>
          At-Risk Assessments: {atRiskAssessmentsCount} | Total
          Assessments: {totalAssessmentsCount} | Total Quizzes:{" "}
          {report?.assessments?.filter((assessment) => assessment.type === "Quiz").length || 0}| Total Exams:{" "}
          {report?.assessments?.filter((assessment) => assessment.type === "Exam").length || 0}| Total Assignment:{" "}
                    ...
                    <tr style={{ borderBottom: "1px solid #ddd", background: "white" }}>
                      ...
                      <td style={{ verticalAlign: "middle", padding: "12px 16px", textAlign: "right" }}>
                        <a
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            toggleAssessment(assessment._id);
                          }}
                        >
                            ...
                            <div className="table-responsive" style={{ borderRadius: "3px" }}>
                              ...
                              >
                                <thead>
                                  ...
                                  >
                                    <th style={{ fontWeight: "600", padding: "10px 15px", border: "none" }}>
                                      LAST NAME
                                    </th>
                                    <th style={{ fontWeight: "600", padding: "10px 15px", border: "none" }}>
                                      FIRST NAME
